export const m = {
  ...
  Close: '닫기',
  View_Contest: '내용 보기',
  Are_you_sure_you_want_to_reset_your_code: '코드 리셋 하시겠습니까?',
  Code_can_not_be_empty: '코드를 비울 수 없습니다.',
  Submit_code_successfully: '제출 성공!',
  You_have_solved_the_problem: '문제 해결',
  Submitted_successfully: '정답!',
  You_have_submitted_a_solution: '솔루션 제출',
